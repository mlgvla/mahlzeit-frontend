...
import '../recipe_search/RecipeDetail.css';

const MyRecipeDetail = (props) => {
    ...
    const recipe = props.myRecipes.find(myRecipe => params.id === myRecipe.id)
    console.log(recipe)
    // use an if in case recipe is not found
    const currentRecipe = recipe.attributes  
...
const mapStateToProps = state => {
    return {myRecipes: state.myRecipes }
}
